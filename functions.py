...
def IndividualTest(c0, #gamma, 
    ...
    for t in range(0, T):
        ...
        samples[1][4][t+1] = \
            ...
            (samples[1][4][t] +p - samples[1][4][t]*samples[0][0][t]) - np.exp(ln_L_t_plus1 )
        ...
        samples[2][4][t+1] = \
            ...
            (samples[2][4][t] +p - samples[2][4][t]*samples[0][0][t]) -  np.exp(ln_L_t_plus1 )
        ...
        samples[3][4][t+1] = \
            ...
            (samples[3][4][t] +p - samples[3][4][t]*samples[0][0][t]) -  np.exp(ln_L_t_plus1 )
        ...
        samples[4][4][t+1] = \
            ...
            (samples[4][4][t] +p - samples[4][4][t]*samples[0][0][t]) -  np.exp(ln_L_t_plus1)
        ...
        samples[5][4][t+1] = \
            ...
            (samples[5][4][t] +p - samples[5][4][t]*samples[0][0][t]) - np.exp(ln_L_t_plus1)
